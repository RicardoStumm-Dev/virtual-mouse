...
def countFingers(image, hand_landmarks, handNo=0):
    ...
    # Conte os dedos
        ...
        cv2.line(image, (finger_tip_x, finger_tip_y),
                 (thumb_tip_x, thumb_tip_y), (255, 0, 0), 2)
        ...
        distance = math.sqrt(((finger_tip_x - thumb_tip_x)
                             ** 2) + ((finger_tip_y - thumb_tip_y)**2))
        print("Tamanho da tela do Computador: ", screen_width,
              screen_height, "Tamanho da janela do resultado: ", width, height)
